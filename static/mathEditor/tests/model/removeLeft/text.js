define([ "intern!tdd", 
	...
	with(tdd){
		suite("Model.removeLeft.text 左删除文本", function(){
			...
			test("text节点中有3个字符，光标在text最后", function(){
			...
			test("text节点中有3个字符，光标在第二个字符的后面", function(){
			...
			test("text节点中有3个字符，光标在第一个字符的后面", function(){
				model.loadData("<root><line><text>abc</text></line></root>");
  				var line = model.getLineAt(0);
  				model.anchor.node = line.firstChild;
			...
			test("text节点前没有节点，text节点中只有一个字符，光标在第一个字符的后面，删除text节点", function(){
			...
			test("text节点前有一个math节点，text节点中只有一个字符，光标在第一个字符的后面，删除text节点", function(){
